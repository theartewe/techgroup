	...
	tinymce.create('tinymce.plugins.InsertImagePlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceInsertImage', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 651,// + parseInt(ed.getLang('insertimage.delta_width', 0)),
					height : 480,// + parseInt(ed.getLang('insertimage.delta_height', 0)),
					inline : 1
				}, {
		...
		getInfo : function() {
			return {
				...
				author:    'Alex Kravets',
				authorurl: 'http://alexkravets.com',
				infourl:   'http://alexkravets.com',
				version:   "1.0"
			};
		}
	});
